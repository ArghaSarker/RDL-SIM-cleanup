...
X, Y, XY_axes = create_patches (
    ...
    save_file           = f'{root_dir}/Train/DN/F-actin_02_DN.npz',
)
...
npz_file =  '../F-actin/Train/DN/F-actin_02_DN.npz'
...
npz_info('../F-actin/Train/DN/F-actin_02_DN.npz')
print('\nafter augmentation\n')
npz_info('../F-actin/Train/DN/augmented_F-actin_02_DN.npz')
...
def visualize_XY_from_npz(npz_file, num_samples):
    ...
    plt.tight_layout()
    plt.show()
    plt.savefig('augmented_F-actin_02_DN_examples.png', bbox_inches='tight')

# Example usage
npz_file = '../F-actin/Train/DN/augmented_F-actin_02_DN.npz' # Replace with your .npz file path
